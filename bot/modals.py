...
class TVReportModal(discord.ui.Modal, title="Report TV Issue"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        embed = build_staff_embed(report_id, "tv", interaction.user, interaction.channel, payload, "Open")
...
class VODReportModal(discord.ui.Modal, title="Report VOD Issue"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        embed = build_staff_embed(report_id, "vod", interaction.user, interaction.channel, payload, "Open")
        view = ReportActionView(self.db, self.cfg.staff_channel_id, self.cfg.support_channel_id, self.cfg.public_updates)
